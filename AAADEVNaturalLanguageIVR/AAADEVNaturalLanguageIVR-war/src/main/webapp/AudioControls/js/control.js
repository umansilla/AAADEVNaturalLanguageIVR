...
function getAbsolutePath() {
    ...
    console.log(loc);
    var pathName = loc.pathname.substring(0, loc.pathname.lastIndexOf('/') - 13);
    console.log(pathName);
    
    return loc.href.substring(0, loc.href.length - ((loc.pathname + loc.search + loc.hash).length - pathName.length)) + "Admin/";
}
